...
import './App.css';
import Alert from './Components/Alert'; //import element Alert yg telah dibuat
import Media from './Components/Media'; //import element Media yg telah dibuat
  ...
  render() {
    return (
      <div className="App container col-sm-6">
        ...
        <Media image="5.png" title="React JS">
            Cras sit amet nibh libero, in gravida nulla. Nulla vel metus  
            scelerisque ante sollicitudin. Cras purus odio, vestibulum  
            in vulputate at, tempus viverra turpis
        </Media>

        <Media image="6.png" title="Angular JS">
          Cras sit amet nibh libero, in gravida nulla. Nulla vel metus  
          scelerisque ante sollicitudin. Cras purus odio, vestibulum  
          in vulputate at, tempus viverra turpis
        </Media> */}
